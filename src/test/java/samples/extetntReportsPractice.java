...
public class extetntReportsPractice {
	public static void main(String[] args) throws IOException{
		...
		//Whenever we are using json and xml type of data, you have to use the markuphelper and create a code block with that 
		//so that your extent report will understand what you want to display and can be visible in a readable code block 
